...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/09/08 19:16:28 by aleexcolleet      #+#    #+#             */
/*   Updated: 2024/09/08 19:17:14 by aleexcolleet     ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	dinner_must_beggin(t_data *data)
{
	...
	dinner_beggin_utils(data, 1);
	i = -1;
	if (2 == dinner_beggin_utils_extended(data, -1))
		return (2);
	dinner_beggin_utils(data, 2);
	return (0);
}
